...
def add_initial_point(canvas):
    # white ball initial point
    pygame.draw.circle(canvas.background, config.initial_point_color, config.white_ball_initial_pos,
                     config.initial_point_radius)
